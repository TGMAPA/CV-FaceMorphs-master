...
def ControlledMorphGeneration(manifold_dataset_clustered_path = "../data/ManifoldAnalysis/manifold_dataset.csv"):
    ...
    for cluster_id in top_clusters:
        ...
        create_cluster_histogram(neighbor_pairs, min_distance, "./ControlledMorphGeneration/MorphGeneration_Pipeline_DistributionalSimilarity_PercentileThreshold/results" + f"/cluster_{cluster_id}_histogram.png", percentile)
        ...
        process_cluster_generation(
            ...
            output_dir_path="./ControlledMorphGeneration/MorphGeneration_Pipeline_DistributionalSimilarity_PercentileThreshold/results",
            alpha=0.5
        )
